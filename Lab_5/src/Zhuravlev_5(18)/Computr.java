...
public class Computr {
	...
	public static void main(String[] args) {
		try {
			...
			d[0] = new Desktop("1000|intel|NVidea|256 gb|ASUS|4|144 Hz|Yes");
			d[1] = new Desktop("600|amd|amd|128 gb|Gigabyte|6|60 Hz|No");
			d[2] = new Desktop("850","intel","","512 gb","MSI","3");
			...
			n[0] = new Noutebook("1800|intel|amd|512 gb|MSI|4|66 Wt'h|Yes");
			n[1] = new Noutebook("3000|amd|NVidea|1024 gb|ASUS|5|90 Wt'h|No");
			n[2] = new Noutebook("700", "intel", "", "256 gb", "Gigabyte", "3");
